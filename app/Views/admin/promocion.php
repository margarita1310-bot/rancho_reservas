    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
        <div class="flex-grow-1">
            ...
            <p class="text-muted mb-0">
                Crea y administra ofertas especiales para atraer clientes y aumentar las ventas. Define descuentos, condiciones y vigencias, y vincula promociones con productos o eventos para maximizar su impacto.
            </p>
        </div>

        <div class="flex-shrink-0">
            <button class="btn btn-primary d-flex align-items-center gap-2 shadow-sm"
            id="btn-create-promocion">
